                                                                    ...
                                                                    <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-6252797" data-id="6252797" data-element_type="column">
                                                                        <div class="elementor-widget-wrap elementor-element-populated" style="padding: 10px 6px 10px 0px;">
                                                                            <div class="elementor-element elementor-element-192b0e4 elementor-widget elementor-widget-heading" data-id="192b0e4" data-element_type="widget" data-widget_type="heading.default">
                                                                                <div class="elementor-widget-container">
                                                                                    <input type="hidden" id="'.$x.'_valor_subtotal_'.str_replace("/", "-", $datas[0]).'_'.$post_id.'" value="'.$dados_gerais[0]["moeda"].' '.number_format(floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))), 2, ',', '.').'">
                                                                                    <h2 class="elementor-heading-title elementor-size-default" class="valor_total" id="'.$x.'_subtotal'.str_replace("/", "-", $datas[0]).'_'.$post_id.'">'.$dados_gerais[0]["moeda"].' '.number_format(floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))), 2, ',', '.').'</h2>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="elementor-element elementor-element-77d6d4d elementor-widget elementor-widget-heading" data-id="77d6d4d" data-element_type="widget" data-widget_type="heading.default">
                                                                                <div class="elementor-widget-container">
                                                                                    <input type="hidden" id="'.$x.'_valor_total_'.str_replace("/", "-", $datas[0]).'_'.$post_id.'" value="'.$dados_gerais[0]["moeda"].' '.number_format(floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))), 2, ',', '.').'">  
                                                                                    <input type="hidden" id="'.$x.'_valor_total_nao_formatado_'.str_replace("/", "-", $datas[0]).'_'.$post_id.'" value="'.floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))).'">  
                                                                                    <input type="hidden" id="'.$x.'_valor_diaria'.str_replace("/", "-", $datas[0]).'_'.$post_id.'" value="'.floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))).'">  
                                                                                    ...
                                                                                    <input type="hidden" id="'.$x.'_valores_diarias_'.str_replace("/", "-", $datas[0]).'_'.$post_id.'" value="'.floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))).' ">
                                                                                    <h2 class="elementor-heading-title elementor-size-default" id="'.$x.'_total_'.str_replace("/", "-", $datas[0]).'_'.$post_id.'">'.(get_post_meta( $id, 'moeda', true)).'   '.number_format(floatval(str_replace(".", "", str_replace(".00", "", $dados_gerais[$x]["valor_original_duplo"]))), 2, ',', '.').'</h2>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
