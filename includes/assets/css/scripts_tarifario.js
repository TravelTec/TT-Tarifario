jQuery(document).ready(function(){ 
  ...
  jQuery("#billing_company").attr("style", "display:none;");
...
function show_div_count_atualizar(data_id_div, code){ 
  ...
  if (jQuery("#tipo_diarias_"+code+"_"+data_id_div).val() == 0) { 
    ...
    jQuery(".noites_pacote"+code).val(noites);
    ...
    if(4 > 4){
      console.log(json_quartos[0]["noites_pacote"]+ ' +++ '+qtd_noites_calculo);
      ...
      retorno += "<input type='hidden' id='setima_diaria' value=''>";  
        ...
        for (var i = 0; i < json_quartos.length; i++) {
          ...
          for(var cnt_noites = 0; cnt_noites < jQuery(".noites_pacote"+code).val(); cnt_noites++){
...
function select_payment_method(nome_hotel, nome_apto, pacote, data_roteiro, noites, single, valores_diarias, triplo, nome_roteiro, regime, periodo, data, id, id_hotel, taxas, i, qtd_noites){
